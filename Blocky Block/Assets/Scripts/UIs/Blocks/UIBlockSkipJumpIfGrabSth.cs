...
{
    public class UIBlockSkipJumpIfGrabSth : UIBlock
    {
        public UIBlockJumpIfGrabSth m_UIBlockJumpFrom {get; set;} = null;
        ...
        public override void Setup(UIBlock _parentBlock = null)
        {
            ...
            if (m_UIBlockJumpFrom == null)
            {
                m_UIBlockJumpFrom = (UIBlockJumpIfGrabSth)_parentBlock;
            }
            m_IsDragging = false;
