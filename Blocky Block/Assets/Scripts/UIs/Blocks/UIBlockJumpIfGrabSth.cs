...
{
    public class UIBlockJumpIfGrabSth : UIBlock
    {
        public UIBlockSkipJumpIfGrabSth m_UIBlockJumpTo {get; set;}
        ...
        public override void Setup(UIBlock _parentBlock = null)
        {
            ...
            if (!m_IsPlaced)
            {
                ...
                m_UIBlockJumpTo = Instantiate(UIManager.Instance.m_BlockDatas[BlockType.SKIP_GRAB_STH].gameObject, transform.position, Quaternion.identity, ideContent.transform).GetComponent<UIBlockSkipJumpIfGrabSth>();
